...
async function AddSondage() {
    ...
    await axios
        .post("https://lesinnovateurs.me/api/admin/add-sondage", data, {
            headers: {
            ...
            <form @submit.prevent="AddSondage">
                <div class="mt-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            v-model="description"
                            class="h-full w-full bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                            name=""
                            id=""
                            cols="30"
                            rows="5"
                    ...
                    <div>
                        ...
                        <select v-model="commune" class="w-52" name="" id="">
                            <option
                                v-for="(commune, index) in CommuneList"
                                :key="index"
                            >
                                {{ commune }}
                            </option>
